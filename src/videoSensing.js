const {
    ArgumentType, BlockType, ProgramModeType,
    Clone, Cast, formatMessage,
    ioVideo: Video
} = window.Scratch;

import VideoMotion from './lib/library.js';
...
class Scratch3VideoSensingBlocks {
    constructor (runtime) {
        ...
        if (this.runtime.ioDevices) {
            ...
            this.runtime.on('PROJECT_LOADED', this.updateVideoDisplay.bind(this));

            // Clear target motion state values when the project starts.
            this.runtime.on('PROJECT_RUN_START', this.reset.bind(this));
